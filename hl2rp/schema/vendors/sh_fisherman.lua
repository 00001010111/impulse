...
File Path:   gamemodes/vanilla-hl2rp/schema/vendors/sh_fisherman.lua
...
VENDOR.RandomTrades = {
	Sell = {
		-- removed GL cus its too op, maybe a counterpart for cp soon
		["ammo_357"] = {Rarity = 850, Cost = {150, 230}, BuyMax = 5},
		["ammo_smg"] = {Rarity = 800, Cost = {80, 330}, BuyMax = 5},
		["SMG1_Grenade"] = {Rarity = 800, Cost = {5000, 12000}, BuyMax = 2},
		["cos_fishcap"] = {Rarity = 980, Cost = {250, 500}, BuyMax = 1},
		["cos_combatgasmask"] = {Rarity = 890, Cost = {100, 150}, BuyMax = 1},
		["wep_pistol"] = {Rarity = 780, Cost = {70, 250}, BuyMax = 2},
		...
		["wep_abracadabra"] = {Rarity = 999, Cost = {12001, 35000}, BuyMax = 1},
		...
		["item_padlock"] = {Rarity = 580, Cost = {10, 20}, BuyMax = 4},
		["util_gear"] = {Rarity = 350, Cost = {19, 65}, BuyMax = 4},
		["util_plastic"] = {Rarity = 360, Cost = {42, 62}, BuyMax = 5},
		["util_gunpowder"] = {Rarity = 690, Cost = {42, 71}, BuyMax = 10},
		["util_fabric"] = {Rarity = 400, Cost = {5, 20}, BuyMax = 10},
		["wep_grenadelauncher"] = {Rarity = 999, Cost = {30000, 50000}, BuyMax = 1}
	},
	Buy = {
		["util_fuel"] = {Cost = {140, 720}},
		["util_biolink"] = {Cost = {10, 45}},
		["util_moonshine"] = {Cost = {175, 250}}
	}
}
...
function VENDOR:OnItemPurchased(class, ply)
	if class == "cos_fishcap" then
		...
		ply:AchievementGive("ach_fisherman")
	end
end
